      ...
      stage3(stage3Id)
{
  ...
  stage1.Config_kP(0, CtlStage12P0);
  stage1.Config_kF(0, CtlStage12F / gear1to2);
  // Slot 1 is for Velocity control
  stage1.Config_kP(1, CtlStage12P1);
  stage1.Config_kF(1, CtlStage12F / gear1to2);
  stage1.ConfigMotionCruiseVelocity(maxVelStage12 * gear1to2);
  stage1.ConfigMotionAcceleration(maxAccelStage12 * gear1to2);
  stage2.Config_kP(0, CtlStage12P0);
  stage2.Config_kF(0, CtlStage12F);
  stage2.Config_kP(1, CtlStage12P1);
  stage2.Config_kF(1, CtlStage12F);
  stage2.ConfigMotionCruiseVelocity(maxVelStage12);
  stage2.ConfigMotionAcceleration(maxAccelStage12);
  stage3.Config_kP(0, CtlStage3P0);
  stage3.Config_kF(0, CtlStage3F);
  stage3.Config_kP(1, CtlStage3P1);
  stage3.Config_kF(1, CtlStage3F);
  stage3.ConfigMotionCruiseVelocity(maxVelStage3);
  stage3.ConfigMotionAcceleration(maxAccelStage3);
